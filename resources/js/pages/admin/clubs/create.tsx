...
export default function ClubsCreate({ icons }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Create', href: '/admin/clubs/create' },
    ];
            ...
            <div className="space-y-6 p-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500">Create a new school club</p>
                    </div>
                </div>
