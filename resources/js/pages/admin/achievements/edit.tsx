...
export default function AchievementsEdit({ achievement, categories, levels }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Edit', href: `/admin/achievements/${achievement.slug}/edit` },
    ];
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(`/admin/achievements/${achievement.slug}`, {
            forceFormData: true,
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Achievement - ${achievement.title}`} />
            ...
            <div className="space-y-6 p-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500">Update achievement details</p>
                    </div>
                </div>
