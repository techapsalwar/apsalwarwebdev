...
export default function FeeStructuresCreate({ categories, classRanges }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Create', href: '/admin/fee-structures/create' },
    ];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="max-w-4xl mx-auto p-6">
                <div className="mb-6">
                    ...
                    <p className="text-gray-500">Create a new fee structure for a specific category and class range</p>
                </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Select the academic year, category, and class range</CardDescription>
                            </CardHeader>
