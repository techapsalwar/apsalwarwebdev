...
import { ArrowLeft, Save, Upload, Star, Trash2 } from 'lucide-react';
...
export default function TestimonialsEdit({ testimonial, types }: Props) {
    const [imagePreview, setImagePreview] = useState<string | null>(
        testimonial.photo ? `/storage/${testimonial.photo}` : null
    );
