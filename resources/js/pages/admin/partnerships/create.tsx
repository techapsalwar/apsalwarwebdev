...
export default function CreatePartnership({ types }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Create', href: '/admin/partnerships/create' },
    ];
            ...
            <div className="space-y-6 p-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500">Create a new partner organization</p>
                    </div>
                </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-2">
                            <Button type="submit" className="flex-1" disabled={processing}>
                                {processing ? 'Creating...' : 'Create Partnership'}
                            </Button>
                        </div>
                    </div>
                </form>
