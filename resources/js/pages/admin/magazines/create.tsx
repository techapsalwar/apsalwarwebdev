...
export default function MagazinesCreate() {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Upload', href: '/admin/magazines/create' },
    ];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 p-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">Upload E-Magazine</h1>
                        <p className="text-gray-500">Add a new school e-magazine</p>
                    </div>
                </div>
                                ...
                                >
                                    {pdfFileName ? (
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-gray-600 dark:text-gray-400">Click to upload magazine PDF</p>
                                            <p className="text-sm text-gray-400">PDF up to 100MB</p>
                                        </div>
                                    )}
                                </div>
                                <input
