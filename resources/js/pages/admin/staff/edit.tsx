...
export default function StaffEdit({ item, departments, types }: StaffEditProps) {
    const breadcrumbs: BreadcrumbItem[] = [
        { title: 'Dashboard', href: '/dashboard' },
        { title: 'Staff', href: '/admin/staff' },
        { title: item.name, href: `/admin/staff/${item.id}/edit` },
    ];

    const fileInputRef = useRef<HTMLInputElement>(null);
    const [photoPreview, setPhotoPreview] = useState<string | null>(
        item.photo ? `/storage/${item.photo}` : null
    );
    const [subjects, setSubjects] = useState<string[]>(item.subjects || []);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post(`/admin/staff/${item.id}`, formData, {
            forceFormData: true,
        });
    };
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Update information for {item.name}.
                            </p>
                        </div>
                    </div>
                    <AlertDialog>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Update qualifications, experience, and subjects taught.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="space-y-2">
